  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "brutalist-primary": 
          "bg-primary text-primary-foreground border-thick border-primary rounded-none hover:bg-secondary hover:text-secondary-foreground",
        "brutalist-secondary":
          "bg-secondary text-secondary-foreground border-thick border-primary rounded-none",
      },
      size: {
