  ...
  if (accepted) {
    return (
      <div className="min-h-screen bg-primary flex items-center justify-center p-4 relative">
        ...
        <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center gap-1 text-secondary/60 text-[8px]">
          <Heart className="w-2 h-2" strokeWidth={1.5} />
          <span>~</span>
